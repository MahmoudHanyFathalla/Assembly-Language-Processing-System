...
int main()
{
    ...
    fpr=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\new_input.txt","r");
    fpw=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\addressed_file.txt","w");
    ...
    fpr=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\addressed_file.txt","r");
    fpw=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\symtab.txt","w");
    ...
    fp1=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\symtab.txt","r");
    i=0;
    ...
    fpr=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\addressed_file.txt","r");
    fpw=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\intermediate.txt","w");
    ...
    fpr=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\intermediate.txt","r");
    fscanf(fpr,"%d%s%s%s%s",&line,&program_name,&mnemonic,&operand,&opcode);
    k=count=0;
    fpw=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\object_file.txt","w");
    ...
    j=l1=c=0;
    fpw=fopen("C:\\Users\\hp\\Desktop\\Cprojects\\cpro\\loader.txt","w");
